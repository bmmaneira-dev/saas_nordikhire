...
const fr: Dictionary = {
  ...
  talentPool: {
    ...
    bodyBefore:
      "Recherche par compétences, viviers organisés par domaine, et recommandations automatiques de candidats précédents adaptés à de nouvelles offres. En attendant, utilise la section",
    linkLabel: "Candidats",
